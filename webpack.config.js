...
var dist = path.join(__dirname, 'workbenches/tableview-workbench/public');
...
var baseURL = (production || lproduction) ? '/tableview-workbench/' : '/';
...
var config = {
  ...
  output: {
    path: outputPath,
    filename: outputFile,
    publicPath: '/workbench/tableview-workbench/'
  },
